...
public class GaussTrickTests
{
    ...
    {
        // Arrange
        List<int> oneElementList = new List<int> { 2 };
    ...
    {
        // Arrange
        List<int> multipleElementsList = new List<int> { 1, 2, 3, 4 };
        List<int> expectedList = new List<int> { 5, 5 };

        // Act
        List<int> result = GaussTrick.SumPairs(multipleElementsList);
    ...
    public void Test_SumPairs_InputHasLargeEvenCountElements_ShouldReturnSumPairs()
    {
        ...
        List<int> expectedList = new List<int> { 11, 11, 11, 11, 11, 11 };
    ...
    public void Test_SumPairs_InputHasLargeOddCountElements_ShouldReturnWithMiddleElement()
    {
        ...
        List<int> expectedList = new List<int> { 8, 8, 8, 4 };
